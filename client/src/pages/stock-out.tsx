...
export default function StockOut() {
  ...
  return (
    <div className="space-y-8">
      {/* Page Title */}
      <div className="mb-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Xuất kho</h1>
        ...
        <CardHeader>
          ...
          {selectedTransactions.length > 0 && (
            <div className="md:hidden mt-4">
              ...
              >
                <Trash2 className="w-4 h-4 mr-2" />
                Xóa {selectedTransactions.length} mục đã chọn
              </Button>
            </div>
          )}
        </CardHeader>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left text-xs font-medium text-gray-500 uppercase tracking-wider py-3 px-2 sm:px-4 hidden md:table-cell">Ngày xuất</th>
